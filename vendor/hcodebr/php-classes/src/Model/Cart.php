...
class Cart extends Model {
	...
	public function addProduct(Product $product){
		...
		$sql->query("INSERT INTO tb_cartsproducts (idcart, idproduct) VALUES (:idcart, :idproduct)", [
			':idcart'=>$this->getidcart(),
			':idproduct'=>$product->getidproduct() // pega $product em vez de $this, pois na condicao da função já passou de qual classe viria a variavel
		]);
	...
	public function setFreight($nrzipcode){
		...
		public static function getMsgError(){
			...
			$msg =(isset($_SESSION[Cart::SESSION_ERROR])) ? $_SESSION[Cart::SESSION_ERROR]:"";// se estiver definido retorna ele mesmo ? se não : retorna vazio""
