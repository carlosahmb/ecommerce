        ...
        <form role="form" action="/admin/users/<?php echo htmlspecialchars( $user["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/password" method="post">
          <div class="box-body">
            <div class="form-group">
              ...
              <input type="password" class="form-control" id="new_pass" name="new_pass" placeholder="Nova senha">
            </div>
            <div class="form-group">
              <label for="new_pass_confirm">Confirme a senha</label>
              <input type="password" class="form-control" id="new_pass_confirm" name="new_pass_confirm" placeholder="Confirme a nova senha">
            </div>
          </div>
          <!-- /.box-body -->
