...
<html lang="pt-br">
  <head>
    ...
    <title>Itech Sys Ecommerce</title>
                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="/profile"><i class="fa fa-user" style="color: rgb(0,128,0)"></i> <?php echo getUserName(); ?></a></li>
                            <li><a href="/logout"><i class="fa fa-close" style="color: rgb(255,0,0)"></i> Sair</a></li>
                            <?php }else{ ?>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="/productsAll">Produtos</a></li>
