...
$app->get("/productsAll", function(){

	$products = Product::listAll();

	$page = new Page();

	$page->setTpl("productsAll");
...
$app->post("/register", function(){
	...
	if(User::checkLoginExist($_POST['email']) === true){
		User::setErrorRegister("Este endereço de e-mail já existe cadastrado! Por favor, informe outro e-mail.");
		header("Location: /login");
		exit;
	}
...
$app->get("/boleto/:idorder", function($idorder){
	...
	$dadosboleto["demonstrativo1"] = "Pagamento de Compra na Loja Itech Sys Ecommerce";
	...
	$dadosboleto["agencia"] = "1585"; // Num da agencia, sem digito
	$dadosboleto["conta"] = "21424";	// Num da conta, sem digito
	...
	// SEUS DADOS
	$dadosboleto["identificacao"] = "Itech Sys Ecommerce";
	$dadosboleto["cpf_cnpj"] = "24.700.731/0001-08";
	$dadosboleto["endereco"] = "Rua Frei Caneca, 690 - Noroeste, 79045-140";
	$dadosboleto["cidade_uf"] = "Campo Grande - MS";
	$dadosboleto["cedente"] = "Itech Sys Ecommerce";
